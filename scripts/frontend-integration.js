 ...
 * This file demonstrates how to integrate Chainvault with a web frontend
 */

// For React/Vue/Angular applications
export class ChainvaultClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChainvaultClient(provider, contractAddress);
